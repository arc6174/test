...
public class RoleServiceImpl extends ServiceImpl<RoleMapper, Role>
    ...
    public Map<String, Object> queryByParamsForTable(RoleQuery roleQuery) {
        ...
        lambdaQueryWrapper.eq(StringUtils.isNotBlank(roleQuery.getRoleName()),Role::getRoleName,roleQuery.getRoleName()).orderByDesc(Role::getId);
    ...
    public void saveRole(Role role){
        ...
        Role temp = this.baseMapper.selectOne(lambdaQueryWrapper);
