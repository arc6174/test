...
public class CustomerController extends BaseController {
    ...
    @RequestMapping("linkManInfoPage")
    public  String linkManInfoPage(Integer cusId, Model model) {
        model.addAttribute("customer", customerService.getById(cusId));
        return "linkman/customer_linkman";
    }

    @RequestMapping("ContactInfoPage")
    public  String ContactInfoPage(Integer cusId, Model model) {
        model.addAttribute("customer", customerService.getById(cusId));
        return "contact/customer_contact";
    }
